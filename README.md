...
在 QGIS 中一鍵繪製熱帶氣旋路徑的工具集，包含兩支獨立的腳本：

| 腳本 | 資料來源 | 呈現內容 |
|---|---|---|
| [`cwa.py`](#1-cwapy--官方路徑與暴風圈) | 中央氣象署（CWA）開放資料 | 中央氣象署「過去路徑 + 預測路徑」，含暴風圈、標籤 |
...
部分長期預報路徑會跨越東經/西經 180° (換日線)，腳本會自動偵測相鄰兩點經度是否跳動超過 180 度：
